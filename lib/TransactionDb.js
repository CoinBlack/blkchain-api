...
TransactionDb.prototype.updateAllAddresses = function() {
  ...
  //   gc();
  //   console.log(Date(UAAStart), 'start', (process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2), 'Mb');
  // }
  console.log(Date(UAAStart), 'memoryUsage - onStart', (process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2), 'Mb');
  db.createReadStream({
    ...
    .on('data', function(data) {
      ...
      var addr = arr[2];
      count++;
      console.log(Date(Date.now()), 'memoryUsage - onData', (process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2), 'Mb');
    ...
    .on('end', function(err) {
      ...
      console.log(Date(UAAEnd), 'memoryUsage - onEnd', (process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2), 'Mb');
      // db.close(function () {
      ...
      // if (typeof gc !== 'undefined') {
      //   gc();
      //   console.log(Date(UAAEnd), 'end', (process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2), 'Mb');
      // }
      // setTimeout(function () {
      //   self.updateAllAddresses();
      // }, 1000 * 60);

...
TransactionDb.prototype.top100 = function(cb) {
  ...
  db.createReadStream({
    ...
    .on('data', function(data) {
      ...
      // console.log('data', data, arrKey);
      // var balanceStr = '' + +arrKey[1] / util.COIN;
      ...
      // result.push({balance: balanceStr + coinStr.substr(1, additionalZeroNum), address: arrKey[2], ts: data.value});
